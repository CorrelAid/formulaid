...
export interface Provider {
	...
	keysUrl: string;
	/** Where the user browses model names. */
	modelsUrl: string;
}
...
export const PROVIDERS: Provider[] = [
	...
	},
	{
		...
		// Filled in by the user; called directly from the browser, so the endpoint
		// has to allow this origin via CORS.
		baseUrl: '',
		defaultModel: CHAT_MODEL,
		keysUrl: '',
		modelsUrl: ''
...
export const demographicVariables: DemographicVariable[] = [
	{
		name: 'Geschlecht',
		question_name: 'sex',
		question_id: '6c19ba5f8ce9',
		question_text: 'Welches Geschlecht haben Sie?',
		question_type: 'select_one',
		answer_options_text: 'Männlich\nWeiblich\nDivers'
	},
	{
		name: 'Alter',
		question_name: 'age',
		question_id: 'bda5c010ec81',
		question_text: 'Wann sind Sie geboren?',
		question_type: 'date',
		answer_options_text: ''
	},
	{
		name: 'Staatsangehörigkeit',
		question_name: 'citizenship',
		question_id: '342695749d3a',
		question_text: 'Haben Sie die deutsche Staatsangehörigkeit?',
		question_type: 'select_one',
		answer_options_text: 'Ja\nNein'
	},
	{
		name: 'Arbeitserlaubnis',
		question_name: 'work_permit',
		question_id: '59ce4a2b4a55',
		question_text: 'Haben Sie eine Arbeitserlaubnis?',
		question_type: 'select_one',
		answer_options_text: 'Ja\nNein'
	},
	{
		name: 'Geburtsland',
		question_name: 'country_of_birth',
		question_id: '2de46741bd8b',
		question_text: 'Sind Sie in Deutschland geboren worden?',
		question_type: 'select_one',
		answer_options_text: 'Ja\nNein'
	},
	{
		name: 'Zuzugsjahr',
		question_name: 'year_of_arrival',
		question_id: 'c9b4739380d4',
		question_text: 'In welchem Jahr sind Sie nach Deutschland gezogen?',
		question_type: 'integer',
		answer_options_text: ''
	},
	{
		name: 'Familienstand',
		question_name: 'marital_status',
		question_id: '7a867899d3dd',
		question_text: 'Welchen Familienstand haben Sie?',
		question_type: 'select_one',
		answer_options_text:
			'ledig, war noch nie verheiratet\nverheiratet oder Eingetragene Lebenspartnerschaft, zusammenlebend\nverheiratet oder Eingetragene Lebenspartnerschaft, aber in Trennung lebend\ngeschieden, Eingetragene Lebenspartnerschaft aufgehoben\nverwitwet, Eingetragene*r Lebenspartner*in verstorben'
	},
	{
		name: 'Schulabschluss',
		question_name: 'school_education',
		question_id: 'bdc227e9ee17',
		question_text: 'Welchen höchsten allgemeinbildenden Schulabschluss haben Sie?',
		question_type: 'select_one',
		answer_options_text:
	...
	{
		name: 'Beschäftigungsverhältnisse',
		question_name: 'employment_status',
		question_id: '9ad82ae1a74b',
		question_text: 'Wie viele Beschäftigungsverhältnisse in abhängiger Beschäftigung haben Sie?',
		question_type: 'select_one',
		answer_options_text:
			'Eins\nZwei\nDrei oder mehr\nNicht abhängig beschäftigt, ausschließlich selbständig oder freiberuflich tätig'
	},
	{
		name: 'Berufliche Tätigkeit',
		question_name: 'occupation',
		question_id: '857077d129f6',
		question_text: 'Welche berufliche Tätigkeit üben sie aus?',
		question_type: 'text',
		answer_options_text: ''
	},
	{
		name: 'Berufliche Stellung',
		question_name: 'occupational_position',
		question_id: 'd36947bca847',
		question_text:
			'Welche berufliche Stellung haben oder hatten Sie in ihrer hauptsächlich ausgeübten Erwerbstätigkeit?',
		question_type: 'select_one',
		answer_options_text:
			'Selbständige*r Landwirt*in oder Genossenschaftsbauer\nSelbständige*r, Freiberufler*in ohne Beschäftigte\nSelbständige*r, Freiberufler*in mit Beschäftigten\nAkademiker*in in Freiem Beruf (Arzt/Ärztin, Rechtsanwalt/Rechtsanwältin, Steuerberater*in und Ähnliches)\nSelbständig im Handel, Im Gastgewerbe, im Handwerk, in der Industrie, in der Dienstleistung, auch Ich-AG oder PGH-Mitglied\nBeamtenanwärter*in\nBeamter/Beamtin, Richter*in, Berufssoldat*in\nAngestellte*r\nArbeiter*in\nin einer beruflichen Ausbildung/Lehre\nMithelfende*r Familienangehörige*r'
	},
	{
		name: 'Internetnutzung',
		question_name: 'communication_usage',
		question_id: '1cda9ca4813b',
		question_text: 'Wie häufig nutzen Sie das Internet?',
		question_type: 'select_one',
		answer_options_text: 'täglich\nmehrmals die Woche\neinmal die Woche\nseltener\nnie'
	},
	{
		name: 'Haushaltsgröße',
		question_name: 'household_size',
		question_id: '0392a1503e37',
		question_text: 'Wie viele Personen leben ständig in Ihrem Haushalt?',
		question_type: 'integer',
		answer_options_text: ''
	},
	{
		name: 'Haushaltsnettoeinkommen',
		question_name: 'household_income',
		question_id: '7ece34c1e38c',
		question_text: 'Wie hoch ist das monatliche Haushaltsnettoeinkommen?',
		question_type: 'select_one',
		answer_options_text:
