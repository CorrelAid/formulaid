...
const translations: Record<Locale, Record<string, string>> = {
	en: {
		...
		'surveyView.researchQuestionsHeading': 'Research questions',
		'surveyView.reasoningHeading': 'Audit trail',
		'surveyView.intro': 'Intro',
		'surveyView.outro': 'Outro',
		'surveyView.demographicsHeading': 'Demographic questions (added automatically)',
		'surveyView.choiceCode': 'Code',
		'surveyView.choiceLabel': 'Answer option',
		'surveyView.exclusive': 'exclusive',
		'surveyView.relevant': 'shown when',
		'surveyView.details': 'Details',
		'surveyView.name': 'Variable name',
		'surveyView.rationale': 'Rationale',
		'surveyView.source': 'Source',
	...
	de: {
		...
		'surveyView.researchQuestionsHeading': 'Forschungsfragen',
		'surveyView.reasoningHeading': 'Begründung',
		'surveyView.intro': 'Einleitung',
		'surveyView.outro': 'Abschluss',
		'surveyView.demographicsHeading': 'Demografische Fragen (automatisch ergänzt)',
		'surveyView.choiceCode': 'Code',
		'surveyView.choiceLabel': 'Antwortoption',
		'surveyView.exclusive': 'exklusiv',
		'surveyView.relevant': 'angezeigt wenn',
		'surveyView.details': 'Details',
		'surveyView.name': 'Variablenname',
		'surveyView.rationale': 'Begründung',
		'surveyView.source': 'Quelle',
