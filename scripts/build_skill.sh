...
# is the authoritative catalogue for the XLSForm allowlist. Pin to a release tag,
# not a branch — a registry change should never alter a shipped skill without a
# formulaid commit. Keep this in step with the formtransform tag in package.json.
FORMTRANSFORM_REF="${FORMTRANSFORM_REF:-v0.1.0}"
